package com.hanhee.spada.mbg.model;
...
public class UmsPermission implements Serializable {
    ...
    @ApiModelProperty(value = "Giá trị đặc quyền")
    private String value;

    @ApiModelProperty(value = "Biểu tượng")
    private String icon;

    @ApiModelProperty(value = "Loại quyền: 0-> thư mục; 1-> thực đơn; Nút 2-> (quyền ràng buộc giao diện)")
